[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/timeline-view-tk/raw/main/dist/timeline_viewer_v0.8.0.pyzw)
...
Download the latest release [timeline_viewer_v0.8.0.pyzw](https://github.com/peter88213/timeline-view-tk/raw/main/dist/timeline_viewer_v0.8.0.pyzw)

- Launch *timeline_viewer_v0.8.0.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python timeline_viewer_v0.8.0.pyzw` (Windows), resp. `python3 timeline_viewer_v0.8.0.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [timeline_viewer_v0.8.0.zip](https://github.com/peter88213/timeline-view-tk/raw/main/dist/timeline_viewer_v0.8.0.zip)

- Extract the *timeline_viewer_v0.8.0* folder from the downloaded zipfile "timeline_viewer_v0.8.0.zip".

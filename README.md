[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/timeline-view-tk/raw/main/dist/timeline_viewer_v0.7.1.pyzw)
...
Download the latest release [timeline_viewer_v0.7.1.pyzw](https://github.com/peter88213/timeline-view-tk/raw/main/dist/timeline_viewer_v0.7.1.pyzw)

- Launch *timeline_viewer_v0.7.1.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python timeline_viewer_v0.7.1.pyzw` (Windows), resp. `python3 timeline_viewer_v0.7.1.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [timeline_viewer_v0.7.1.zip](https://github.com/peter88213/timeline-view-tk/raw/main/dist/timeline_viewer_v0.7.1.zip)

- Extract the *timeline_viewer_v0.7.1* folder from the downloaded zipfile "timeline_viewer_v0.7.1.zip".
